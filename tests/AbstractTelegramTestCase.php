...
abstract class AbstractTelegramTestCase extends WebTestCase
{
     ...
     */
    protected string $mockedGrinwayTelegramClientPlainResponse = '{ "ok": true, "result": {"name": "TEST", "stickers": [{"file_id": "TEST", "emoji": "😏"},{"file_id": "TEST", "emoji": "👍"},{"file_id": "TEST", "emoji": "💀"},{"file_id": "TEST", "emoji": "💕"}], "file_path": "TEST"} }';
    protected string $mockedGrinWayTelegramFileClientPlainResponse = 'TEST';
    ...
    protected function setUpMockedTelegramService(): void
    {
        ...
        $grinwayTelegramClientResponseGenerator = static function () use ($mockedGrinwayTelegramClientPlainResponse): \Generator {
            while (true) {
                yield new MockResponse($mockedGrinwayTelegramClientPlainResponse);
            }
        };
        ...
        $mockedGrinWayTelegramFileClientPlainResponse = $this->mockedGrinWayTelegramFileClientPlainResponse;
        $grinwayTelegramFileClientResponseGenerator = static function () use ($mockedGrinWayTelegramFileClientPlainResponse): \Generator {
            while (true) {
                yield new MockResponse($mockedGrinWayTelegramFileClientPlainResponse);
            }
        };
